 ...
 **/
@Embeddable
public class QGeneralagentEarning  {

    /**
     * 一月份充值额
     */
    @ApiModelProperty(value = "一月份充值额")
    private Double janEarning;

    /**
     * 二月份充值额
     */
    @ApiModelProperty(value = "二月份充值额")
     ...
     * 九月份充值额
     */
    @ApiModelProperty(value = "九月份充值额")
    private Double septEarning;


    /**
     * 十月份充值额
     */
    @ApiModelProperty(value = "十月份充值额")
     ...
     * 十一月份充值额
     */
    @ApiModelProperty(value = "十一月份充值额")
     ...
     * 十二月份充值额
     */
    @ApiModelProperty(value = "十二月份充值额")
    ...
    public Double getSeptEarning() {
        return septEarning;
    }

    public void setSeptEarning(Double septEarning) {
        this.septEarning = septEarning;
    }

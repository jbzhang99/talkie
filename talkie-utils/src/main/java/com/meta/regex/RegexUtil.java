...
public class RegexUtil {
    ...
    public final static boolean isPhone(String text) {
        return match(text, "^((14[0-9]{1})|(17[0-9])|(13[0-9])|(15[0-9])|(18[0-9]))\\d{8}$");
    }
    ...
    public final static boolean isMobile(String text) {
        ...
        return match(text, "^(((14[0-9]{1})|(17[0-9])|(13[0-9]{1})|(15[0-9]{1})|(18[0-9]{1}))+\\d{8})$");
    }

...
import com.meta.*;
import com.meta.feignfallback.merchant.MerchantAccountFallBack;
 ...
 */
@FeignClient(name = ServiceNames.TALKIE_CORE,fallbackFactory = MerchantAccountFallBack.class)
@RequestMapping(VersionNumbers.NEW_SERVICE_VERSIONS)
@ApiIgnore
public interface MerchantAccountClient {

    @CacheEvict(value = RedisValue.FIND_MERCHANT_ACCOUNT,allEntries = true)
    ...
    @Cacheable(value = RedisValue.FIND_MERCHANT_ACCOUNT, key = "'search_merchant_account_conditions_filters='+#p0+'_and_sorts='+#p1+'_and_size='+#p2+'_and_page='+#p3", unless = "!#result.successFlg")

...
/**
 * create by lhq
 * create date on  18-2-23上午10:24
 *
 * @version 1.0
 **/
@Component
public class SecMerchantAccountFallBack implements FallbackFactory<SecMerchantAccountClient> {
    @Override
    public SecMerchantAccountClient create(Throwable cause) {
        return new SecMerchantAccountClient(){
            @Override
